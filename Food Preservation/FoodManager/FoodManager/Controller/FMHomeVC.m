...
@interface FMHomeVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,FMFooterDelegate,FMAddDetialsDelegate>

@property (nonatomic,strong) UICollectionView *collectionView;
@property (nonatomic,strong) UICollectionViewFlowLayout *flowLayout;
@property (nonatomic,strong) FMFooter *footer;
...
@implementation FMHomeVC

- (void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    self.navigationItem.title = @"Food Preservation";
}
...
- (void)addFood{
    FMAddDetials *detialVC = [[FMAddDetials alloc]initWithType:@"Home"];
...
- (UITableViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if(indexPath.section == 0){
        if(self.normalArr.count == 0){
            ...
            FMFood *food = self.normalArr[indexPath.row];
            cell.imageView.image = [UIImage imageNamed:[self handleImageNameClass:food.foodType]];
        ...
        if(self.recentlyArr.count == 0){
            ...
            FMFoodCell *cell = (FMFoodCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"FMFoodCell" forIndexPath:indexPath];
            FMFood *food = self.recentlyArr[indexPath.row];
            cell.imageView.image = [UIImage imageNamed:[self handleImageNameClass:food.foodType]];
            cell.name.text = food.name;
            return (UITableViewCell *)cell;
        }
        ...
        if(self.nonArr.count == 0){
            ...
            FMFoodCell *cell = (FMFoodCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"FMFoodCell" forIndexPath:indexPath];
            FMFood *food = self.nonArr[indexPath.row];
            cell.imageView.image = [UIImage imageNamed:[self handleImageNameClass:food.foodType]];
            cell.name.text = food.name;
            return (UITableViewCell *)cell;
        }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section == 0){
        ...
        detialVC.time = [NSString stringWithFormat:@"%d",0];
    }
