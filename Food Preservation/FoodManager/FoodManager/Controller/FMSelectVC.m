...
@interface FMSelectVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.textColor = [UIColor colorWithHexString:@"#2F8B6E"];
    ...
    lineView.backgroundColor = [UIColor colorWithHexString:@"#2F8B6E"];
    [cell addSubview:lineView];
    return cell;
}
