...
@interface FFTBall_NavigateController ()

@end

@implementation FFTBall_NavigateController
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated{
    if (self.childViewControllers.count > 0) {
        ...
        if([viewController isKindOfClass:[FFTBall_AddPageVC class]]){
