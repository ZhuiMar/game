...
- (void)commonInit{
	_backgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"3_Touchpad_bg"]];
	...
	handleImageFrame.size = CGSizeMake(65,60.5);
...
//	[_handleImageView setFrame:handleImageFrame];
	...
	if ([self.delegate respondsToSelector:@selector(analogueStickDidChangeValue:)])
	{
		[self.delegate analogueStickDidChangeValue:nil];
	}
}
