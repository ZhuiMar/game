...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
       ...
       if (@available(ios 13, *)) {
           ...
           FFTBall_HomaPageVC *homeVc = [[FFTBall_HomaPageVC alloc]init];
           FFTBall_NavigateController *navigate = [[FFTBall_NavigateController alloc] initWithRootViewController:homeVc];
